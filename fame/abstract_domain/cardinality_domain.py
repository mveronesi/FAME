...
class XAIDomain(PerturbationDomain):
    ...
    def __init__(self,
        ...
        self.cardinalities: Union[int, List[int]] = cardinalities # if list of int, WARNING: the length is equal to batchsize
    ...
    def get_upper(self, x: Tensor, w: Tensor, b: Tensor, **kwargs: Any) -> Tensor:
        ...
        res:Tensor= get_upper_box_l0(x_min=x_min,
                                    x_max=x_max,
                                    x_center=x_center,
                                    w=w, b=b, mask_xai=self.xai_mask,
                                    mask_free=self.free_mask,
                                    channel=self.channel,
                                    data_format=self.data_format,
                                    cardinality=self.cardinalities, **kwargs)
    ...
    def get_lower(self, x: Tensor, w: Tensor, b: Tensor, **kwargs: Any) -> Tensor:
        ...
        return get_lower_box_l0(x_min=x_min,
                                x_max=x_max,
                                x_center = x_center,
                                w=w, b=b,
